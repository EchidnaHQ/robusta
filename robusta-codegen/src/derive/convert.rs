...
fn from_java_value_macro_derive_impl(input: DeriveInput) -> syn::Result<TokenStream> {
    ...
    Ok(quote! {
        ...
        #[automatically_derived]
        impl#generics ::robusta_jni::convert::FromJavaValue<'env> for #impl_target#generic_args {
            type Source = ::robusta_jni::jni::objects::JObject<'env>;

            fn from(source: Self::Source, env: ::robusta_jni::jni::JNIEnv<'env>) -> Self {
...
fn tryfrom_java_value_macro_derive_impl(input: DeriveInput) -> syn::Result<TokenStream> {
    ...
    Ok(quote! {
        ...
        #[automatically_derived]
        impl#generics ::robusta_jni::convert::TryFromJavaValue<'env> for #impl_target#generic_args {
            type Source = ::robusta_jni::jni::objects::JObject<'env>;

            fn try_from(source: Self::Source, env: ::robusta_jni::jni::JNIEnv<'env>) -> ::robusta_jni::jni::errors::Result<Self> {
                #(#data_fields_env_init)*
                #(#class_fields_env_init)*
            ...
            match instance_field_data {
                ...
                Some((instance, attr)) => {
                    ...
                    let instance_field_type_assertion = quote_spanned! { ty.span() =>
                        ::robusta_jni::assert_type_eq_all!(#ty, ::robusta_jni::jni::objects::AutoLocal<'static>);
                    };
